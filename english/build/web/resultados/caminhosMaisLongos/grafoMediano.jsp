            ...
            <table width="70%" border='1'>               
                ...
                <c:forEach var="idCurr" items="${idsCurriculos}">                                                                         
                    <tr>
                        ...
                        <td>
                            <a href="exibirGrafo?idGrafo=${idCurr}&tipo=caminhoMaisLongoGrafoMediano&gephi=true" title="View with Gephi JS (without the edges's costs)">View with Gephi</a>                           
                            |
                            <a href="exibirGrafo?idGrafo=${idCurr}&tipo=caminhoMaisLongoGrafoMediano&graphViz=true" title="View with GraphViz (with the edges's costs)">View with GraphViz</a>                           
                            |
                            <a href="baixarGrafo?idGrafo=${idCurr}&tipo=caminhoMaisLongoGrafoMediano&gexf=true" title="Download GEXF file - Gephi's extension">Download GEXF</a>
                            |
                            <a href="baixarGrafo?idGrafo=${idCurr}&tipo=caminhoMaisLongoGrafoMediano&dot=true" title="Download DOT file">Download DOT/GV</a>
                            |
                            <a href="baixarGrafo?idGrafo=${idCurr}&tipo=caminhoMaisLongoGrafoMediano&txt=true" title="Download the graph with the same structure of the datasets">Download TXT</a>
                        </td>
                    </tr>
                </c:forEach> 
            </table>                      
