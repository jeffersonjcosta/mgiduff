    ...
    <body>
        ...
        <div class="conteudo"> 
            ...
            <h2 style="line-height: 5px;">
                &rsaquo;&rsaquo; Longest paths - Program flowchart
                <hr/>
            </h2>
            
            Choose a curriculum to see the longest paths, using the Bellman-Ford Algorithm.
            <br />
            ...
            <table width="70%" border='1'>               
                ...
                <c:forEach var="idCurr" items="${idsCurriculos}">                                                                         
                    <tr>
                        ...
                        <td>
                            <a href="exibirGrafo?idGrafo=${idCurr}&tipo=caminhoMaisLongoGradeCurricular&gephi=true" title="View with Gephi JS (without the edges's costs)">View with Gephi</a>                           
                            |
                            <a href="exibirGrafo?idGrafo=${idCurr}&tipo=caminhoMaisLongoGradeCurricular&graphViz=true" title="View with GraphViz (with the edges's costs)">View with GraphViz</a>                           
                            |
                            <a href="baixarGrafo?idGrafo=${idCurr}&tipo=caminhoMaisLongoGradeCurricular&gexf=true" title="Download GEXF file - Gephi's extension">Download GEXF</a>
                            |
                            <a href="baixarGrafo?idGrafo=${idCurr}&tipo=caminhoMaisLongoGradeCurricular&dot=true" title="Download DOT file">Download DOT/GV</a>
                            |
                            <a href="baixarGrafo?idGrafo=${idCurr}&tipo=caminhoMaisLongoGradeCurricular&txt=true" title="Download the graph with the same structure of the datasets">Download TXT</a>
                        </td>
                    </tr>
                </c:forEach> 
            </table>                      
