            ...
            <table width="80%" border='1'>               
                ...
                <c:forEach var="idCurr" items="${idsCurriculos}">                                                                         
                    <tr>
                        ...
                        <td>
                            <a href="exibirGrafo?idGrafo=${idCurr}&tipo=arestasMaisPesadas&gephi=true" title="View the graph with Gephi JS (without the edges's costs)">View with Gephi</a>                          
                            |
                            <a href="exibirGrafo?idGrafo=${idCurr}&tipo=arestasMaisPesadas&graphViz=true" title="View the graph with GraphViz (with the edges's costs)">View with GraphViz</a>                           
                            |                                                    
                            ...
                            |
                            <a href="resultados?idGrafo=${idCurr}&tipo=rankingArestasMaisPesadas&dataset=cml&soma=${tipoDeSoma}" title="List the heavier edges (highest to lowest)">Ranking</a>                          
                        </td>
                    </tr>
                </c:forEach> 
            </table>                      
