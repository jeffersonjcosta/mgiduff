    ...
    <body>
        ...
        <div class="conteudo">   
            ...
            <h2 style="line-height: 5px;">
                &rsaquo;&rsaquo; Longest paths - Median Graph
                <hr/>
            </h2>
            
            Choose a curriculum to see the longest paths of the medians graphs, using the Bellman-Ford Algorithm.
            <br />
            ...
            <table width="70%" border='1'>               
                ...
                <c:forEach var="idCurr" items="${idsCurriculum}">                                                                         
                    <tr>
                        ...
                        <td>
                            <a href="viewGraph?idGraph=${idCurr}&type=longestPathMedianGraph&gephi=true" title="View with Gephi JS (without the edges's costs)">View with Gephi</a>                           
                            |
                            <a href="viewGraph?idGraph=${idCurr}&type=longestPathMedianGraph&graphViz=true" title="View with GraphViz (with the edges's costs)">View with GraphViz</a>                           
                            |
                            <a href="downloadGraph?idGraph=${idCurr}&type=longestPathMedianGraph&gexf=true" title="Download GEXF file - Gephi's extension">Download GEXF</a>
                            |
                            <a href="downloadGraph?idGraph=${idCurr}&type=longestPathMedianGraph&dot=true" title="Download DOT file">Download DOT/GV</a>
                            |
                            <a href="downloadGraph?idGraph=${idCurr}&type=longestPathMedianGraph&txt=true" title="Download the graph with the same structure of the datasets">Download TXT</a>
                        </td>
                    </tr>
                </c:forEach> 
            </table>                      
