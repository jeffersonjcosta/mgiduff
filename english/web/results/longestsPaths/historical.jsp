    ...
    <body>
        ...
        <div class="conteudo">   
            ...
            <h2 style="line-height: 5px;">
                &rsaquo;&rsaquo; Longest paths - Historical Curriculum
                <hr/>
            </h2>
            
            Choose the student you want to find the longest path using the Bellman-Ford Algorithm.
            <br />
            Total of generated graphs: <b>${idsCurriculumSize}</b>
            <br /><br />
            <table width="85%" border='1'>               
                ...
                <c:forEach var="idStudent" items="${idsStudents}">                                                                         
                    <c:set var="id1" value="${fn:split(idStudent, '|')}" />  
                    <tr>
                        <td width="20%">${id1[0]}</td>
                        <td width="20%">${id1[1]}</td>                      
                        <td>
                            <a href="viewGraph?idGraph=${idStudent}&type=longestPathHistorical&gephi=true" title="View with Gephi JS (without the edges's costs)">View with Gephi</a>                                                       
                            |
                            <a href="viewGraph?idGraph=${idStudent}&type=longestPathHistorical&graphViz=true" title="View with GraphViz (with the edges's costs)">View with GraphViz</a>                           
                            |
                            <a href="downloadGraph?idGraph=${idStudent}&type=longestPathHistorical&gexf=true" title="Download GEXF file - Gephi's extension">Download GEXF</a>
                            |
                            <a href="downloadGraph?idGraph=${idStudent}&type=longestPathHistorical&dot=true" title="Download DOT file">Download DOT/GV</a>
                            |
                            <a href="downloadGraph?idGraph=${idStudent}&type=longestPathHistorical&txt=true" title="Download the graph with the same structure of the datasets">Download TXT</a>                                                                                                                                   
                        </td>
                    </tr>
                </c:forEach> 
            </table>                      
