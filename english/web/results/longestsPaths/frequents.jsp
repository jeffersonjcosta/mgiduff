            ...
            <table width="70%" border='1'>               
                ...
                <c:forEach var="idCurr" items="${idsCurriculum}">                                                                         
                    <tr>
                        ...
                        <td>                            
                            <a href="results?idGraph=${idCurr}&type=rankingLP" title="Ranking com os paths mais longos mais frequents">&nbsp;Ranking</a>
                            |
                            <a href="results?idGraph=${idCurr}&type=allPaths" title="All paths possibles for curricullum ${idCurr} - Using the backtracking algorithm">View all paths possibles</a>                            
                        </td>
                    </tr>
                </c:forEach> 
            </table>                      
