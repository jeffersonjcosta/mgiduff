    ...
    <body>
        ...
        <div class="conteudo">
            ...
            <h2 style="line-height: 5px;">
                &rsaquo;&rsaquo; Heavier edges - Using Longests Paths
                <hr/>            
            </h2>
            ...
            <table width="80%" border='1'>               
                ...
                <c:forEach var="idCurr" items="${idsCurriculum}">                                                                         
                    <tr>
                        ...
                        <td>
                            <a href="viewGraph?idGraph=${idCurr}&type=heaviestsEdges&gephi=true" title="View the graph with Gephi JS (without the edges's costs)">View with Gephi</a>                          
                            |
                            <a href="viewGraph?idGraph=${idCurr}&type=heaviestsEdges&graphViz=true" title="View the graph with GraphViz (with the edges's costs)">View with GraphViz</a>                           
                            |                                                    
                            <a href="downloadGraph?idGraph=${idCurr}&type=heaviestsEdges&gexf=true" title="Download GEXF file - Gephi's extension">Download GEXF</a>
                            |
                            <a href="downloadGraph?idGraph=${idCurr}&type=heaviestsEdges&dot=true" title="Download DOT file">Download DOT/GV</a>
                            |
                            <a href="downloadGraph?idGraph=${idCurr}&type=heaviestsEdges&txt=true" title="Download the graph with the same structure of the datasets">Download TXT</a>
                            |
                            <a href="results?idGraph=${idCurr}&type=heaviestEdgesRank&dataset=lp&sum=${sumType}" title="List the heavier edges (highest to lowest)">Ranking</a>                          
                        </td>
                    </tr>
                </c:forEach> 
            </table>                      
