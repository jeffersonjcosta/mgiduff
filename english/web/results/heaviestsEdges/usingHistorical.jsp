            ...
            <table width="80%" border='1'>               
                ...
                <c:forEach var="idCurr" items="${idsCurriculum}">                                                                         
                    <tr>
                        ...
                        <td>
                            <a href="viewGraph?idGraph=${idCurr}&type=heaviestsEdges&gephi=true" title="View with Gephi Gephi JS (without the edges's costs)">View with Gephi</a>                          
                            |
                            <a href="viewGraph?idGraph=${idCurr}&type=heaviestsEdges&graphViz=true" title="View with GraphViz (with the edges's costs)">View with GraphViz</a>                           
                            |                                                    
                            ...
                            |
                            <a href="results?idGraph=${idCurr}&type=heaviestEdgesRank&dataset=historical&sum=${sumType}" title="List the heavier edges (highest to lowest)">Ranking</a>                          
                        </td>
                    </tr>
                </c:forEach> 
            </table>                      
