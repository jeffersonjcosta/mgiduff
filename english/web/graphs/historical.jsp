    ...
    <body>
        ...
        <div class="conteudo">  
            ...
            <h2 style="line-height: 5px;">
                &rsaquo;&rsaquo; Graphs - Historical Curriculum
                <hr/>
            </h2>
            
            Choose the student you want to view the graph.
            <br />
            ...
            <table width="80%" border='1'>               
                ...
                <c:forEach var="idStudent" items="${idsStudents}">                                           
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="viewGraph?idGraph=${idStudent}&type=historical&gephi=true" title="View with Gephi JS (without the edges's costs)">View with Gephi</a>                           
                            |
                            <a href="viewGraph?idGraph=${idStudent}&type=historical&graphViz=true" title="View with GraphViz (with the edges's costs)">View with GraphViz</a>                           
                            |
                            <a href="downloadGraph?idGraph=${idStudent}&type=historical&gexf=true" title="Download GEXF file - Gephi's extension">Download GEXF</a>
                            |
                            <a href="downloadGraph?idGraph=${idStudent}&type=historical&dot=true" title="Download DOT file">Download DOT/GV</a>
                            |
                            <a href="downloadGraph?idGraph=${idStudent}&type=historical&txt=true" title="Download the graph with the same structure of the datasets">Download TXT</a>                                                       
                        </td>
                    </tr>
                </c:forEach> 
            </table>            
