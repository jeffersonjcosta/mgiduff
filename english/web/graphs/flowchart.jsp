    ...
    <body>
        ...
        <div class="conteudo">   
            ...
            <h2 style="line-height: 5px;">
                &rsaquo;&rsaquo; Graphs - Program flowchart
                <hr/>
            </h2>
            ...
            <table width="65%" border='1'>               
                ...
                <c:forEach var="idCurr" items="${idsCurriculum}">                                                                         
                    <tr>
                        ...
                        <td>
                            <a href="viewGraph?idGraph=${idCurr}&type=flowchart&gephi=true" title="View with Gephi JS (without the edges's costs)">View with Gephi</a>                           
                            |
                            <a href="viewGraph?idGraph=${idCurr}&type=flowchart&graphViz=true" title="View with GraphViz (with the edges's costs)">View with GraphViz</a>                           
                            |
                            <a href="downloadGraph?idGraph=${idCurr}&type=flowchart&gexf=true" title="Download GEXF file - Gephi's extension">Download GEXF</a>
                            |
                            <a href="downloadGraph?idGraph=${idCurr}&type=flowchart&dot=true" title="Download DOT file">Download DOT/GV</a>
                            |
                            <a href="downloadGraph?idGraph=${idCurr}&type=flowchart&txt=true" title="Download the graph with the same structure of the datasets">Download TXT</a>                                                       
                        </td>
                    </tr>
                </c:forEach> 
            </table>                      
