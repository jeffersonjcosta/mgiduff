            ...
            <table width="60%" border='1'>               
                ...
                <c:forEach var="idCurr" items="${idsCurriculos}">                                                                         
                    <tr>
                        ...
                        <td>
                            <a href="exibirGrafo?idGrafo=${idCurr}&tipo=grafoMedio&gephi=true" title="View with Gephi JS (without the edges's costs)">View with Gephi</a>                           
                            |
                            <a href="exibirGrafo?idGrafo=${idCurr}&tipo=grafoMedio&graphViz=true" title="View with GraphViz (with the edges's costs)">View with GraphViz</a>                           
                            |
                            <a href="baixarGrafo?idGrafo=${idCurr}&tipo=grafoMedio&gexf=true" title="Download GEXF file - Gephi's extension">Download GEXF</a>
                            |
                            <a href="baixarGrafo?idGrafo=${idCurr}&tipo=grafoMedio&dot=true" title="Download DOT file">Download DOT/GV</a>
                            |
                            <a href="baixarGrafo?idGrafo=${idCurr}&tipo=grafoMedio&txt=true" title="Download the graph with the same structure of the datasets">Download TXT</a>                                                       
                        </td>
                    </tr>
                </c:forEach> 
            </table>                      
