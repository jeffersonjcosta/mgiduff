    ...
    <body>
                    ...
                    <ul class="submenu-1"> 
                        <li><a href="#">Caminhos mais longos &rsaquo;</a>                        
                            <ul class="submenu-2">                                                     
                                ...
                                <li><a href='${pageContext.request.contextPath}/grafos?listarIds=true&menu=resultados&item=caminhosMaisLongos&subitem=grafoMaximo'>Grafo mediano</a></li>
        ...
        <div class="conteudo">   
            ...
            <h2 style="line-height: 5px;">
                &rsaquo;&rsaquo; Grafos - Grafo m&aacute;ximo
                <hr/>
            </h2>
            
            Escolha o curr&iacute;culo para o qual deseja visualizar o grafo m&aacute;ximo.            
            <br />
            ...
            <table width="60%" border='1'>               
                <tr style="background-color: #e2e2e2;">                    
                    ...
                    <td><b>Grafo m&aacute;ximo</b></td>
                </tr>
                <c:forEach var="idCurr" items="${idsCurriculos}">                                                                         
                    <tr>
                        <td width="20%">${idCurr}</td>                      
                        <td>
                            <a href="exibirGrafo?idGrafo=${idCurr}&tipo=grafoMaximo&gephi=true" title="Visualizar grafo m&aa&aacute;ximo com Gephi JS (sem peso das arestas)">Visualizar com Gephi</a>                           
                            |
                            <a href="exibirGrafo?idGrafo=${idCurr}&tipo=grafoMaximo&graphViz=true" title="Visualizar grafo mediano com GraphViz/Vis.JS (com peso das arestas)">Visualizar com GraphViz</a>                           
                            |
                            <a href="baixarGrafo?idGrafo=${idCurr}&tipo=grafoMaximo&gexf=true" title="Baixar arquivo GEXF - extensão do Gephi">Baixar GEXF</a>
                            |
                            <a href="baixarGrafo?idGrafo=${idCurr}&tipo=grafoMaximo&dot=true" title="Baixar arquivo em DOT Language - linguagem do GraphViz">Baixar DOT/GV</a>
                            |
                            <a href="baixarGrafo?idGrafo=${idCurr}&tipo=grafoMaximo&txt=true" title="Baixar grafo m&eacute;dio com a mesma estrutura dos datasets">Baixar TXT</a>                                                       
                        </td>
                    </tr>
                </c:forEach> 
            </table>                      
