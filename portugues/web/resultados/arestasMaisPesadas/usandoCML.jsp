    ...
    <body>
        ...
        <div class="conteudo">
            ...
            <h2 style="line-height: 5px;">
                &rsaquo;&rsaquo; Arestas mais pesadas - Usando os caminhos mais longos (CML)
                <hr/>            
            </h2>
                ...
                <c:forEach var="idCurr" items="${idsCurriculos}">                                                                         
                    <tr>
                        ...
                        <td>
                            ...
                            |
                            <a href="resultados?idGrafo=${idCurr}&tipo=rankingArestasMaisPesadas&dataset=cml&soma=${tipoDeSoma}" title="Listar as arestas mais pesadas (da maior para a menor)">Ranking</a>                          
                        </td>
                    </tr>
                </c:forEach> 
            </table>                      
