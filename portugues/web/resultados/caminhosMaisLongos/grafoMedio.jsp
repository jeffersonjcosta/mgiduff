    ...
    <body>
        ...
        <div class="conteudo">   
            ...
            <h2 style="line-height: 5px;">
                &rsaquo;&rsaquo; Caminhos mais longos - Grafo M&eacute;dio
                <hr/>
            </h2>
            
            Escolha o curr&iacute;culo para o qual deseja encontrar o caminho mais longo do grafo m&eacute;dio, utilizando o algoritmo de Bellman-Ford.
            <br />
            ...
            <table width="70%" border='1'>               
                ...
                <c:forEach var="idCurr" items="${idsCurriculos}">                                                                         
                    <tr>
                        ...
                        <td>
                            <a href="exibirGrafo?idGrafo=${idCurr}&tipo=caminhoMaisLongoGrafoMedio&gephi=true" title="Visualizar grafo com Gephi JS (sem peso das arestas)">Visualizar com Gephi</a>                           
                            |
                            <a href="exibirGrafo?idGrafo=${idCurr}&tipo=caminhoMaisLongoGrafoMedio&graphViz=true" title="Visualizar grafo com GraphViz/Vis.JS (com peso das arestas)">Visualizar com GraphViz</a>                           
                            |
                            <a href="baixarGrafo?idGrafo=${idCurr}&tipo=caminhoMaisLongoGrafoMedio&gexf=true" title="Baixar arquivo GEXF - extensão do Gephi">Baixar GEXF</a>
                            |
                            <a href="baixarGrafo?idGrafo=${idCurr}&tipo=caminhoMaisLongoGrafoMedio&dot=true" title="Baixar arquivo em DOT Language - linguagem do GraphViz">Baixar DOT/GV</a>
                            |
                            <a href="baixarGrafo?idGrafo=${idCurr}&tipo=caminhoMaisLongoGrafoMedio&txt=true" title="Baixar grafo com a mesma estrutura dos datasets">Baixar TXT</a>
                        </td>
                    </tr>
                </c:forEach> 
            </table>                      
