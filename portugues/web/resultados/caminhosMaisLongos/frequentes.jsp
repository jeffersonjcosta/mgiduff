    ...
    <body>
        ...
        <div class="conteudo"> 
            ...
            <h2 style="line-height: 5px;">
                &rsaquo;&rsaquo; Caminhos mais longos - Mais frequentes
                <hr/>
            </h2>
            
            Escolha o curr&iacute;culo para o qual deseja visualizar os caminhos mais longos mais frequentes
            <br />
            ...
            <table width="70%" border='1'>               
                <tr style="background-color: #e2e2e2;">                    
                    ...
                    <td><b>Caminhos mais longos mais frequentes</b></td>
                </tr>
                <c:forEach var="idCurr" items="${idsCurriculos}">                                                                         
                    <tr>
                        ...
                        <td>                            
                            ...
                            |
                            <a href="resultados?idGrafo=${idCurr}&tipo=todosCaminhos" title="Todos os caminhos possíveis para o currículo ${idCurr} - Usando o algoritmo de backtracking">Visualizar todos os caminhos poss&iacute;veis</a>                            
                        </td>
                    </tr>
                </c:forEach> 
            </table>                      
